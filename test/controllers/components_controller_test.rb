...
class ComponentsControllerTest < ActionController::TestCase
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post :create, component: { coverage: @component.coverage, name: @component.name, product_id: @component.product_id }
    end
  ...
  test "should update component" do
    patch :update, id: @component, component: { coverage: @component.coverage, name: @component.name, product_id: @component.product_id }
    assert_redirected_to component_path(assigns(:component))
  end
